...
Configuration `cfg-2026-08-17-v3` first normalized the rate tables supplied by the owner on 2026-08-17. Current configuration `cfg-2026-08-17-v4` retains those records and adds versioned mileage settings. The complete normalized records are emitted to the human-readable configuration JSON under `data/configurations/` and are defined in `app/rate_reference.py` for reproducible installation.
